...
router.get('/admin', authMiddleware, authorizeRoles('Admin', 'Kepala Dinas'), rentalController.getAllApplications);
...
router.patch('/:id/verify-letter', authMiddleware, authorizeRoles('Kepala Dinas', 'Admin'), rentalController.verifyLetter);
